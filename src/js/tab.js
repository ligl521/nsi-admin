    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
                    ...
                    '<li class="layui-this" lay-id="-1" data-url="' + _config.mainUrl + '"><i class="fa fa-television"></i> 首页</li>',
                    '</ul>',
                    '<div class="kit-tab-tool layui-bg-green"><i class="fa fa-refresh"></i> 刷新&nbsp;</div>',
                    '<div class="kit-tab-tool-body layui-anim layui-anim-upbit">',
                    '<ul>',
                    '<li class="kit-item" data-target="refresh">刷新当前页面</li>',
                    '<li class="kit-line"></li>',
                    '<li class="kit-item" data-target="closeCurrent">关闭当前页面</li>',
                    '<li class="kit-item" data-target="closeOther">关闭其他页面</li>',
                    '<li class="kit-line"></li>',
                    '<li class="kit-item" data-target="closeAll">关闭所有页面</li>',
                    '</ul>',
                    '</div>',
